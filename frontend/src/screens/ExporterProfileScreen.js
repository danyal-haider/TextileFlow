...
const ExporterProfileScreen = ({ navigation }) => {
    ...
    const fetchStats = async () => {
        try {
            ...
            const myOrders = allOrders.filter(order => {
                ...
                return orderUserId?.toString() === userInfo?._id?.toString();
            });
    ...
    const uploadAvatar = async (uri) => {
        ...
        try {
            const response = await axios.post(`${API_URL}/qc/upload-image`, formData, {
                headers: {
                ...
                <Card style={styles.profileCard}>
                    ...
                    {!isEditing && (
                        <View style={styles.nameSection}>
                            <Text style={styles.name}>{userInfo?.name || 'Exporter Name'}</Text>
                            <View style={styles.roleBadge}>
                                <Text style={styles.roleBadgeText}>EXPORTER</Text>
                            </View>
                        </View>
                    )}
                </Card>
                    ...
                    {isEditing ? (
                        <View style={styles.editForm}>
                            ...
                            <TextInput
                                ...
                                placeholder="Brief overview of production capacities, specializations..."
                                multiline
                                numberOfLines={3}
                                placeholderTextColor={colors.textLight}
                            />
...
export default ExporterProfileScreen;
